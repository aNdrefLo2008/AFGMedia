...
function CardsHero() {
  return (
    <div className="relative w-[420px] sm:w-[480px] md:w-[600px] lg:w-[700px] h-[500px]">
      {/* Top Card */}
      <div className="absolute z-30 xl:-top-10 xl:left-44 top-0 left-40 bg-white transition-colors duration-500 dark:bg-gray-900 shadow-2xl lg:px-6 lg:py-8 px-4 py-6 rounded-3xl flex flex-col justify-center gap-4 w-52 lg:w-64 xl:w-72 ">
        <CardContent title="Video Editing" img={video_editing_img} Icon={FaPhotoFilm} />
      </div>

      {/* Middle Card */}
      <div className="absolute z-20 top-48 left-0 bg-white transition-colors duration-500 dark:bg-gray-900 shadow-2xl lg:px-6 lg:py-8 px-4 py-6 rounded-3xl flex flex-col justify-center gap-4 w-52 lg:w-64 xl:w-72">
        <CardContent title="Web Dev" img={coding_img} Icon={CgWebsite} />
      </div>

      {/* Bottom Card */}
      <div className="absolute z-10 lg:top-60 top-52 left-56 lg:left-60 xl:left-72 bg-white transition-colors duration-500 dark:bg-gray-900 shadow-2xl lg:px-6 lg:py-8 px-4 py-6 rounded-3xl flex flex-col justify-center gap-4 w-52 lg:w-64 xl:w-72">
