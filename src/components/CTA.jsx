    ...
    return (
        <div className='sm:py-20 py-10 md:px-0 px-4 text-center flex justify-center items-center bg-white dark:bg-black'>
            <motion.div
                ...
                className='relative z-50 xl:max-w-7xl sm:max-w-5xl max-w-2xl lg:p-28 sm:p-20 p-16 rounded-3xl overflow-hidden bg-white dark:bg-gradient-to-r dark:from-gray-900 dark:to-black flex flex-col gap-5'
            >

                <div className='absolute -left-20 -top-20 blur-3xl p-20 rounded-full bg-gradient-to-r from-emerald-300 to-indigo-300 dark:bg-gradient-to-r dark:from-emerald-800 dark:to-indigo-800' />
                <div className='absolute -right-20 top-20 blur-3xl p-20 rounded-full bg-purple-300 dark:bg-indigo-800' />
                <div className='absolute -bottom-32 left-32 blur-3xl p-20 rounded-full bg-blue-300 dark:bg-blue-800' />
